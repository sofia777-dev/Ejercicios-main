...
q = Question('¿Cuál es la capital de Francia?', 'París', 'Londres', 'Berlín', 'Madrid') # crear una pregunta
ask(q) # mostrar la pregunta en la ventana
btn_OK.clicked.connect(check_answer) # conectar el botón de responder a la función de verificar la respuesta
